...
One important impact of the Redux architecture was the code quality improvement. The separation of concerns between action creators, reducers, and components made our unit tests more focused and valuable. The pure functions that Redux allowed us to use made the test easier to write. A component controller became only a bit of plumbing between Redux, an HTML template, and some utility functions.
